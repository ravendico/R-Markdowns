...
\textit{Answer:} 
\begin{itemize}
\item About 82.15\% (value of R-squared) of the variance of the response variable is explained by the model.
\item There is statistically significant linear relationship between the predictor variables namely \textit{displacement}, \textit{weight}, \textit{year}, and \textit{origin} and the response variable \textit{mpg}
