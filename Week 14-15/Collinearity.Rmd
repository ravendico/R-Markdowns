...
\textit{Answer: }
The results in Problem 2 and 4 show what happens when the predictor variables are highly correlated with each other. Since x1 and x2 have high correlation, then using them both in a model to predict y results in x2 having no statistically significant relationship with y. However, using them separately in two models results in each having significant linear relationship with y.
